 ...
 */
import { JsonObject } from '@angular-devkit/core/src/json';
import { Analytics, EventOptions, PageviewOptions, ScreenviewOptions, TimingOptions } from '@angular-devkit/core/src/analytics/api';

...
import { FileBuffer, Host, HostCapabilities, HostWatchOptions, ReadonlyHost, Stats } from '@angular-devkit/core/src/virtual-fs/host/interface';
import { SimpleMemoryHost } from '@angular-devkit/core/src/virtual-fs/host/memory';

...
import type { DynamicRoutes, PageChecker } from 'next/dist/server/router';
...
import BaseServer, { Options, FindComponentsResult, MiddlewareRoutingItem, RoutingItem, RequestContext } from 'next/dist/server/base-server';
...
export default class NextNodeServer extends BaseServer {
    ...
    protected getFontLoaderManifest(): any;

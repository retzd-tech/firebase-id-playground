import * as express from "firebase-functions/node_modules/@types/express";
import { EventContext } from "firebase-functions/lib/v1/cloud-functions";
import { DeploymentOptions, RuntimeOptions, SUPPORTED_REGIONS } from "firebase-functions/lib/v1/function-configuration";
import * as analytics from "firebase-functions/v1/analytics";
import * as auth from "firebase-functions/v1/auth";
import * as database from "firebase-functions/lib/v1/providers/database";
...
export declare class FunctionBuilder {
    ...
    get https(): {
         ...
         */
        onRequest: (handler: (req: https.Request, resp: express.Response) => void | Promise<void>) => import("firebase-functions/lib/v1/cloud-functions").HttpsFunction;
        /**
         * Declares a callable method for clients to call using a Firebase SDK.
         * @param handler A method that takes a data and context and returns a value.
         */
        onCall: (handler: (data: any, context: https.CallableContext) => any | Promise<any>) => import("firebase-functions/lib/v1/cloud-functions").HttpsFunction & import("firebase-functions/lib/v1/cloud-functions").Runnable<any>;
    };
    get tasks(): {
        /**
    ...
    get remoteConfig(): {
         ...
         */
        onUpdate: (handler: (version: remoteConfig.TemplateVersion, context: EventContext) => PromiseLike<any> | any) => import("firebase-functions/lib/v1/cloud-functions").CloudFunction<remoteConfig.TemplateVersion>;
    };
    get storage(): {
        /**

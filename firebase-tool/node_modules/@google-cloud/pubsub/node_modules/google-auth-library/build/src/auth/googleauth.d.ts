...
import { DefaultTransporter, Transporter } from '@google-cloud/pubsub/node_modules/google-auth-library/build/src/transporters';
import { Compute } from '@google-cloud/pubsub/node_modules/google-auth-library/build/src/auth/computeclient';
import { CredentialBody, JWTInput } from '@google-cloud/pubsub/node_modules/google-auth-library/build/src/auth/credentials';
import { IdTokenClient } from '@google-cloud/pubsub/node_modules/google-auth-library/build/src/auth/idtokenclient';
import { GCPEnv } from '@google-cloud/pubsub/node_modules/google-auth-library/build/src/auth/envDetect';
import { JWT, JWTOptions } from '@google-cloud/pubsub/node_modules/google-auth-library/build/src/auth/jwtclient';
import { Headers, OAuth2ClientOptions, RefreshOptions } from '@google-cloud/pubsub/node_modules/google-auth-library/build/src/auth/oauth2client';
import { UserRefreshClient, UserRefreshClientOptions } from '@google-cloud/pubsub/node_modules/google-auth-library/build/src/auth/refreshclient';
import { Impersonated, ImpersonatedOptions } from '@google-cloud/pubsub/node_modules/google-auth-library/build/src/auth/impersonated';
import { ExternalAccountClientOptions } from '@google-cloud/pubsub/node_modules/google-auth-library/build/src/auth/externalclient';
import { BaseExternalAccountClient } from '@google-cloud/pubsub/node_modules/google-auth-library/build/src/auth/baseexternalclient';
import { AuthClient } from '@google-cloud/pubsub/node_modules/google-auth-library/build/src/auth/authclient';
/**

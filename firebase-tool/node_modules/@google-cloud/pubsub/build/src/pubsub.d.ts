...
import { Schema, SchemaType, ISchema, SchemaView } from '@google-cloud/pubsub/build/src/schema';
import { Snapshot } from '@google-cloud/pubsub/build/src/snapshot';
import { Subscription, SubscriptionOptions, CreateSubscriptionOptions, CreateSubscriptionCallback, CreateSubscriptionResponse, DetachSubscriptionCallback, DetachSubscriptionResponse } from '@google-cloud/pubsub/build/src/subscription';
import { Topic, GetTopicSubscriptionsCallback, GetTopicSubscriptionsResponse, CreateTopicCallback, CreateTopicResponse, TopicMetadata } from '@google-cloud/pubsub/build/src/topic';

...
/// <reference types="node" />
/// <reference types="node" />
import { BodyResponseCallback, DecorateRequestOptions, GetConfig, Metadata, MetadataCallback, ServiceObject, SetMetadataResponse } from '@google-cloud/storage/build/src/nodejs-common';
...
import { ResponseBody, Duplexify } from '@google-cloud/storage/build/src/nodejs-common/util';
import { CRC32CValidatorGenerator } from '@google-cloud/storage/build/src/crc32c';
import { URL } from 'url';
import { DeleteCallback, DeleteOptions, SetMetadataOptions } from '@google-cloud/storage/build/src/nodejs-common/service-object';

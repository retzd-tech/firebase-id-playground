import { Metadata, MetadataCallback, ServiceObject } from '@google-cloud/storage/build/src/nodejs-common';
import { ResponseBody } from '@google-cloud/storage/build/src/nodejs-common/util';
